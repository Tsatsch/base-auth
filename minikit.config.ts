...
export const minikitConfig = {
  ...
  miniapp: {
    version: "1",
    name: "Base Auth", 
    subtitle: "On-Chain 2FA Authenticator", 
    description: "Secure on-chain two-factor authentication (2FA) management for the Base blockchain. Store and manage your 2FA secrets with blockchain security.",
    ...
    ogTitle: "Base Auth - On-Chain Authenticator",
